...
| `adaptive_stop.py` | ✅ 2 | 218 | 2026-06-04 | adaptive_stop.py — Adaptive Stop Engine per D-091 (with 2026-05-23 bug corrections). |
...
| `choppiness.py` | ✅ 3 | 73 | 2026-05-16 | Opening Choppiness scorer — Tree V3.3 §Q4. |
...
| `five_min_system.py` | ✅ 9 | 1142 | 2026-06-05 | FiveMinSystem — 5-min Decision Maker with full D-077 lifecycle. |
| `output_schema.py` | ✅ 4 | 52 | 2026-05-24 | T1Setup — canonical output per D-041. |
| `quality_tier.py` | ✅ 2 | 93 | 2026-05-31 | Quality Tier V2 · Auth Table V1 (pattern x day_type x tier) -> contracts. |
