...
| `exit_verifier.py` | ✅ 2 | 235 | 2026-08-16 | T4 — books close only after Sierra proves the exit actually happened. |
| `feed_watchdog.py` | ✅ 1 | 170 | 2026-07-17 | Feed watchdog — block fires when canonical trading streams are stale. |
| `fill_poller.py` | ✅ 6 | 1207 | 2026-08-16 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `phone_alert.py` | ✅ 7 | 105 | 2026-08-13 | phone_alert — IDEA-2: critical alerts to Michael's phone (Michael 07-13). |
