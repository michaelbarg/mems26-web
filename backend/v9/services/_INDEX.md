...
| `ntfy_notify.py` | ✅ 6 | 232 | 2026-08-18 | Push notifications via ntfy.sh for trading events (P1.6 + K7a). |
| `phone_alert.py` | ✅ 12 | 112 | 2026-08-17 | phone_alert — IDEA-2: critical alerts to Michael's phone (Michael 07-13). |
...
| `sierra_command.py` | ✅ 25 | 1073 | 2026-09-07 | Sierra command file writer for DEMO/LIVE execution paths. |
| `sierra_ledger.py` | ✅ 2 | 331 | 2026-09-01 | Sierra-sourced LIVE ledger (journal L8) — the ground truth for real money. |
| `sierra_pnl_reconcile.py` | ✅ 2 | 283 | 2026-09-01 | T-10 — fill `v9_trades.pnl_sierra` from the Sierra fills journal. |
| `sierra_position_reconciler.py` | ✅ 12 | 1229 | 2026-09-04 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
...
| `trade_context.py` | ✅ 25 | 1238 | 2026-08-29 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
