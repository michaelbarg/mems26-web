...
|---|---|---|---|---|
| `agent_heartbeat.py` | ▶ entry/test | 53 | — | Write docs/reports/AGENT_HEARTBEAT.json — the session-watch liveness beacon the |
...
| `d1_exit_proof.sh` | — | 108 | — | D1-EXIT Proof Script — runs on SIM after Michael's Sierra reload. |
...
| `stall_exit_backtest.py` | ▶ entry/test | 235 | — | STALL_EXIT backtest — flag OFF, research only (Michael 2026-07-11). |
...
| `trade_activity_feed.py` | ▶ entry/test | 197 | 2026-07-10 | Trade Activity Log feeder — extracts fill/stop-move events from Sierra's binary log. |
