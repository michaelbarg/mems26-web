...
export const SYSTEM_META: Record<number, SystemMeta> = {
  1: { id: 1, name: 'Day Type',    color: '#6366f1', type: 'FIRING' },
  2: { id: 2, name: '5-Min',       color: '#06b6d4', type: 'FIRING' },
  3: { id: 3, name: 'Footprint',   color: '#a855f7', type: 'OBSERVING' },
...
/** Firing systems: make entry decisions (row 1 in Switcher) */
export const FIRING_SYSTEMS = [1, 2, 4] as const;

/** Observing systems: provide context (row 2 in Switcher) */
export const OBSERVING_SYSTEMS = [3, 5, 6] as const;
