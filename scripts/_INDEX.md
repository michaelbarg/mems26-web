...
| `mobile_relay.py` | ▶ entry/test | 155 | 2026-08-05 | MEMS26 mobile relay — pushes snapshot + polls emergency commands from Render. |
...
| `ops_log.py` | ✅ 17 | 134 | 2026-07-17 | Central ops log (N12 — Michael 2026-07-16: "קובץ לוג שמקבל את הכל"). |
...
| `s4_full_audit.py` | ▶ entry/test | 1193 | — | SYSTEM-4 (Woodies CCI) FULL AUDIT — every trading day we have. |
...
| `system2_full_audit.py` | ▶ entry/test | 1182 | — | system2_full_audit.py — SYSTEM-2 full audit across every session we have. |
