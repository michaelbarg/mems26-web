...
| `bar_aggregator_5min.py` | ✅ 3 | 217 | 2026-05-29 | 5-min Bar Aggregator — builds OHLCV bars from incoming ticks. |
...
| `daytype_watchdog.py` | ✅ 2 | 206 | 2026-08-08 | Day-type writer watchdog — detects AND heals a stale v9_day_type_state. |
| `entry_guard.py` | ✅ 3 | 133 | — | PRE_SEND_ENTRY_GUARD_V1 — refuse a LIVE entry the account state guarantees to kill. |
...
| `fill_poller.py` | ✅ 6 | 1181 | 2026-08-09 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `local_alert.py` | ✅ 1 | 97 | 2026-07-27 | local_alert — LOUD local alerts on the trading Mac (Michael 2026-07-27, after |
| `margin_sizing.py` | ✅ 1 | 151 | 2026-07-28 | MARGIN_AWARE_SIZING_V1 — never send an order the account cannot carry. |
...
| `ntfy_notify.py` | ✅ 3 | 175 | 2026-08-11 | Push notifications via ntfy.sh for trading events (P1.6 + K7a). |
| `phone_alert.py` | ✅ 6 | 95 | 2026-07-27 | phone_alert — IDEA-2: critical alerts to Michael's phone (Michael 07-13). |
| `reconcile.py` | ✅ 1 | 248 | 2026-07-27 | Item-20 — Sierra truth reconcile + naked-stop detector. |
| `sierra_command.py` | ✅ 19 | 821 | 2026-08-08 | Sierra command file writer for DEMO/LIVE execution paths. |
| `sierra_ledger.py` | ✅ 2 | 311 | 2026-07-08 | Sierra-sourced LIVE ledger (journal L8) — the ground truth for real money. |
| `sierra_position_reconciler.py` | ✅ 6 | 904 | 2026-07-28 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
| `tpo_history_snapshotter.py` | ✅ 2 | 344 | 2026-06-04 | P31 Issue B — TPO history snapshotter. |
| `trade_context.py` | ✅ 17 | 986 | 2026-08-04 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
