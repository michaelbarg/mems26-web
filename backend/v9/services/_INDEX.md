...
| `fill_poller.py` | ✅ 1 | 419 | 2026-07-08 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `sierra_command.py` | ✅ 7 | 209 | 2026-07-08 | Sierra command file writer for DEMO/LIVE execution paths. |
...
| `trade_context.py` | ✅ 7 | 664 | 2026-06-30 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
