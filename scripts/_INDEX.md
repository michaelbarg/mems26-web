...
| `good_pattern_fix.py` | ▶ entry/test | 979 | — | good_pattern_fix.py — why the patterns that MAKE money don't fire enough, and |
| `good_pattern_gates.py` | ▶ entry/test | 193 | — | good_pattern_gates.py — gate-side census for the money-making patterns. |
| `good_pattern_oos.py` | ▶ entry/test | 243 | — | good_pattern_oos.py — the honesty pass on top of good_pattern_fix.py. |
| `good_pattern_ts_ladder.py` | ▶ entry/test | 157 | — | good_pattern_ts_ladder.py — TREND_STEP measured with ITS OWN ladder. |
