...
| `reconcile.py` | ✅ 3 | 470 | 2026-09-01 | Item-20 — Sierra truth reconcile + naked-stop detector. |
| `sierra_command.py` | ✅ 22 | 963 | 2026-08-21 | Sierra command file writer for DEMO/LIVE execution paths. |
| `sierra_ledger.py` | ✅ 2 | 329 | 2026-08-20 | Sierra-sourced LIVE ledger (journal L8) — the ground truth for real money. |
| `sierra_pnl_reconcile.py` | ✅ 2 | 276 | 2026-08-22 | T-10 — fill `v9_trades.pnl_sierra` from the Sierra fills journal. |
| `sierra_position_reconciler.py` | ✅ 12 | 1144 | 2026-08-29 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
