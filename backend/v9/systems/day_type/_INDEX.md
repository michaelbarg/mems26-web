...
| `classifier_core.py` | ✅ 2 | 139 | 2026-07-08 | classifier_core — pure-function core of the 7-type day-type classifier. |
...
| `daytype_classifier.py` | ✅ 2 | 283 | 2026-07-08 | daytype_classifier.py — RELATIVE day-type classifier (S1, reads the dynamic table). |
...
| `relative_features.py` | ✅ 2 | 223 | 2026-07-10 | relative_features.py — RELATIVE day-type input features (S1). |
...
| `state_machine.py` | ✅ 5 | 1169 | 2026-07-10 | Day Type Engine — 13-stage state machine (A1 -> C3). |
