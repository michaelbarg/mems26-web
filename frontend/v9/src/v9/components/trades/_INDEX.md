...
| `TradeDetailsModal.tsx` | ✅ 2 | 454 | 2026-06-07 | What fired |
...
| `TradeReviewTab.tsx` | ✅ 1 | 300 | 2026-07-02 | Pattern label — same fallback chain as PatternPerformanceStrip (pattern_id → classification → trigger). |
...
| `TradesTable.tsx` | ✅ 1 | 394 | 2026-07-02 | Pattern at entry: stamped SoT column if present, else display-derived. |
| `TradesView.tsx` | ✅ 1 | 189 | 2026-07-02 | Header |
