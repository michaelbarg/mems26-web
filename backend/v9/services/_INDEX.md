...
| `fill_poller.py` | ✅ 1 | 477 | 2026-07-08 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `sierra_command.py` | ✅ 9 | 218 | 2026-07-09 | Sierra command file writer for DEMO/LIVE execution paths. |
| `sierra_ledger.py` | ✅ 1 | 311 | 2026-07-08 | Sierra-sourced LIVE ledger (journal L8) — the ground truth for real money. |
| `sierra_position_reconciler.py` | ✅ 2 | 92 | 2026-07-09 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
