...
| G-18 | S1 | Neutral=sides==2; escalation-only doctrine | 🔧 **SIGNED (מייקל 07-19)** — דוקטרינת Neutral A/B/C מאושרת · 🟢 CONFIRMED | `daytype_classifier.py` Neutral; `shadow_reclass.py:85-88` + skip כש-new engine | מייקל(דוקטרינה) · **S124 G8** | 07-19 |
