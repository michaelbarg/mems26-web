...
| `fill_poller.py` | ✅ 2 | 553 | 2026-07-10 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `reconcile.py` | ✅ 1 | 210 | 2026-07-11 | Item-20 — Sierra truth reconcile + naked-stop detector. |
| `sierra_command.py` | ✅ 9 | 226 | 2026-07-09 | Sierra command file writer for DEMO/LIVE execution paths. |
| `sierra_ledger.py` | ✅ 1 | 311 | 2026-07-08 | Sierra-sourced LIVE ledger (journal L8) — the ground truth for real money. |
| `sierra_position_reconciler.py` | ✅ 4 | 196 | 2026-07-13 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
| `tpo_history_snapshotter.py` | ✅ 2 | 344 | 2026-06-04 | P31 Issue B — TPO history snapshotter. |
| `trade_context.py` | ✅ 8 | 705 | 2026-07-09 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
