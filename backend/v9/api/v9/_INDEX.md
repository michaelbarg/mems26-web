...
| `bars.py` | ✅ 8 | 1607 | 2026-08-03 | V9 API: Bar data endpoints — receives Bridge pushes for all bar types. |
...
| `context_radar.py` | ✅ 3 | 329 | 2026-08-06 | GET /api/v9/context/radar — one call, the whole picture (Michael 2026-07-29: |
...
| `daytype_classify_routes.py` | ✅ 2 | 458 | 2026-07-29 | V9 API: run the NEW relative day-type classifier over a historical day (read-only). |
| `gateway_routes.py` | ✅ 1 | 133 | 2026-08-07 | API routes for Trading Gateway status + manual route_setup (P-TG.5). |
...
| `mobile_monitor.py` | ✅ 1 | 638 | 2026-08-07 | mobile_monitor — מוניטור-אייפון (Michael 2026-07-15, מוגש מהבקאנד). |
...
| `system6_routes.py` | ✅ 1 | 227 | 2026-07-20 | System 6 — active-trade diagnosis endpoint (read-only). |
| `tpo_routes.py` | ✅ 6 | 508 | 2026-08-06 | API: /api/v9/tpo/* — System 5 TPO Profile. |
