...
| `five_min_system.py` | ✅ 10 | 1479 | 2026-06-18 | FiveMinSystem — 5-min Decision Maker with full D-077 lifecycle. |
| `output_schema.py` | ✅ 4 | 52 | 2026-05-24 | T1Setup — canonical output per D-041. |
| `quality_tier.py` | ✅ 2 | 95 | 2026-06-09 | Quality Tier V2 · Auth Table V1 (pattern x day_type x tier) -> contracts. |
