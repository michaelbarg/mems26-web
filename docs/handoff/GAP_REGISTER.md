...
| G-11 | S1/S2/S4 | מספרי against-Dalton 15/16/17 | 🟢 **CONFIRMED (partial)** | T1 via `/chart/replay` (PG trust-dialog חסם audit_pattern_miss ישיר): 21 trades w/VA · **10 against** (CONT@wrong VA edge). Doc `PATTERN_INTEL_NUMBERS_2026-07-19.md`. 07-16 בלי VA/0 trades. C1–C3 hit 0% בנתוני-replay | cursor→cowork | 07-19 |
