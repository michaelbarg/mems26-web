...
| `system6_routes.py` | ✅ 1 | 195 | 2026-07-06 | System 6 — active-trade diagnosis endpoint (read-only). |
| `tpo_routes.py` | ✅ 6 | 485 | 2026-06-03 | API: /api/v9/tpo/* — System 5 TPO Profile. |
| `trade_commands.py` | ✅ 1 | 181 | 2026-07-10 | V9 API: Trade command/result endpoints for DLL communication. |
| `trade_review_routes.py` | ✅ 1 | 55 | 2026-06-15 | V9 API: trade review marks (read/write to v9_trades.quality.review). |
| `trades.py` | ✅ 2 | 601 | 2026-07-09 | V9 API: Trades + management log CRUD. |
