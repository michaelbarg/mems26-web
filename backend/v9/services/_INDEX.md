...
| `daytype_watchdog.py` | ✅ 2 | 206 | 2026-08-07 | Day-type writer watchdog — detects AND heals a stale v9_day_type_state. |
...
| `fill_poller.py` | ✅ 5 | 1121 | 2026-08-07 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `ntfy_notify.py` | ✅ 2 | 90 | 2026-08-07 | Push notifications via ntfy.sh for trading events (P1.6). |
...
| `sierra_command.py` | ✅ 18 | 786 | 2026-08-07 | Sierra command file writer for DEMO/LIVE execution paths. |
