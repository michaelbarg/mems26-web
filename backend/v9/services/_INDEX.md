...
| `fill_poller.py` | ✅ 1 | 252 | 2026-07-02 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `reconcile.py` | ⚠️ orphan? | 204 | 2026-07-03 | Item-20 — Sierra truth reconcile + naked-stop detector. |
| `sierra_command.py` | ✅ 5 | 192 | 2026-07-02 | Sierra command file writer for DEMO/LIVE execution paths. |
