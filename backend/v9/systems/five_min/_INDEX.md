...
| `five_min_system.py` | ✅ 14 | 2295 | 2026-08-13 | FiveMinSystem — 5-min Decision Maker with full D-077 lifecycle. |
| `output_schema.py` | ✅ 5 | 53 | 2026-08-11 | T1Setup — canonical output per D-041. |
| `quality_tier.py` | ✅ 2 | 111 | 2026-07-15 | Quality Tier V2 · Auth Table V1 (pattern x day_type x tier) -> contracts. |
| `setup_emitter.py` | ✅ 4 | 229 | 2026-07-31 | setup_emitter — PATH A: full Layer 3 + validator + gateway composer. |
