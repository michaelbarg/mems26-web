...
| `entry_guard.py` | ✅ 3 | 155 | 2026-08-21 | PRE_SEND_ENTRY_GUARD_V1 — refuse a LIVE entry the account state guarantees to kill. |
...
| `phone_alert.py` | ✅ 11 | 112 | 2026-08-17 | phone_alert — IDEA-2: critical alerts to Michael's phone (Michael 07-13). |
| `reconcile.py` | ✅ 2 | 321 | 2026-08-21 | Item-20 — Sierra truth reconcile + naked-stop detector. |
...
| `sierra_position_reconciler.py` | ✅ 9 | 1091 | 2026-08-23 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
| `swallow_counter.py` | ⚠️ orphan? | 43 | 2026-08-23 | §2 safety: global exception-swallow counter. |
| `tpo_history_snapshotter.py` | ✅ 2 | 344 | 2026-06-04 | P31 Issue B — TPO history snapshotter. |
| `trade_context.py` | ✅ 23 | 1058 | 2026-08-20 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
