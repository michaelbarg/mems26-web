...
| `bars.py` | ✅ 8 | 1431 | 2026-07-20 | V9 API: Bar data endpoints — receives Bridge pushes for all bar types. |
...
| `daytype_classify_routes.py` | ✅ 2 | 368 | 2026-07-19 | V9 API: run the NEW relative day-type classifier over a historical day (read-only). |
