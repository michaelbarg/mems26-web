...
| `daytype_classifier.py` | ✅ 2 | 148 | — | daytype_classifier.py — RELATIVE day-type classifier (S1, reads the dynamic table). |
...
| `opening_detector_v2.py` | ✅ 3 | 149 | — | opening_detector_v2.py — MEASURED 5-type opening detector (S1, fixes over-DRIVE). |
...
| `state_machine.py` | ✅ 5 | 1123 | 2026-06-11 | Day Type Engine — 13-stage state machine (A1 -> C3). |
