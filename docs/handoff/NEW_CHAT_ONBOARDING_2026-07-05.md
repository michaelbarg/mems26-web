...
**🆕 הודלק 07-05 (~22:05, פסק-Michael) — בתוקף ליום-שני:** `STOP_RESOLVER_V1=1`
(item-4 — ה-lever מס' 1: סטופ מבני מרצועת-ATR) · `TARGET_ZONES_V1=1` (item-22 —
t2/t3 למדפי-קונפלואנס) · `S4_ENTRY_CONFIRM_V1=1` (item-6 — בר-אישור לפני ירי-S4).
snapshot: `20260705T190115Z_enable-item4-22-6`. **⚠️ שלושה שינויים-מתקשרים יחד —
קרא את הירי-הראשון ביום-שני בזהירות (ייחוס קשה); שקול לכבות אחד אם ההתנהגות מפתיעה.**
...
_(item-4/22/6 עברו ל-§1 — הודלקו 07-05.)_
