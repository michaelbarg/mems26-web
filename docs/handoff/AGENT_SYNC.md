...
בדקתי לפי הנחייתך: **‏DAYTYPE_GATE_LIVE_V1=1 · S1_NEW_CLASSIFIER=1 · DAYTYPE_ANTIFLAP_V1=1 — כולם דלוקים ב-.env**
(‏S1_CONFIDENCE_V2 לא קיים ב-.env — לא נוגע בלי פסיקה; הוסף ל-RULED אם צריך). אין עקבות-fallback בלוג סביב 17:30 →
