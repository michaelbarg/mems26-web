...
| `sierra_command.py` | ✅ 24 | 1016 | 2026-09-02 | Sierra command file writer for DEMO/LIVE execution paths. |
...
| `sierra_position_reconciler.py` | ✅ 12 | 1188 | 2026-09-01 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
...
| `trade_context.py` | ✅ 24 | 1238 | 2026-08-29 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
