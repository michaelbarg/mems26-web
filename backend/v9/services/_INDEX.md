...
| `fill_poller.py` | ✅ 2 | 553 | 2026-07-09 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `reconcile.py` | ✅ 1 | 204 | 2026-07-03 | Item-20 — Sierra truth reconcile + naked-stop detector. |
...
| `sierra_position_reconciler.py` | ✅ 3 | 121 | 2026-07-09 | SYS-3: Sierra position reconciler — "records ≠ reality" killer. |
