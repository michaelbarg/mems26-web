...
|---|---|---|---|---|
| `ChartV5b.tsx` | ✅ 1 | 1108 | 2026-09-14 | Avoid browser "Failed to fetch" when backend is busy (Woodies/bar handlers). |
...
| `LiveTradeOverlay.tsx` | ✅ 1 | 129 | 2026-08-18 | gone |
| `SetupMarkersOverlay.tsx` | ✅ 1 | 196 | 2026-09-14 | T-320: Setup markers overlay on the main chart. |
