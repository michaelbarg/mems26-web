...
| `fill_poller.py` | ✅ 5 | 1131 | 2026-08-08 | Fill poller — reads trade_fills.json from Sierra DLL and drives TradeManager. |
...
| `ntfy_notify.py` | ✅ 2 | 141 | 2026-08-07 | Push notifications via ntfy.sh for trading events (P1.6 + K7a). |
...
| `sierra_command.py` | ✅ 18 | 786 | 2026-08-08 | Sierra command file writer for DEMO/LIVE execution paths. |
