...
| `live_ledger_routes.py` | ✅ 1 | 95 | 2026-07-08 | LIVE ledger endpoint (journal L8) — what Sierra ACTUALLY executed. |
...
| `system6_routes.py` | ✅ 1 | 149 | 2026-07-06 | System 6 — active-trade diagnosis endpoint (read-only). |
| `tpo_routes.py` | ✅ 6 | 485 | 2026-06-03 | API: /api/v9/tpo/* — System 5 TPO Profile. |
| `trade_commands.py` | ✅ 1 | 171 | 2026-07-07 | V9 API: Trade command/result endpoints for DLL communication. |
| `trade_review_routes.py` | ✅ 1 | 55 | 2026-06-15 | V9 API: trade review marks (read/write to v9_trades.quality.review). |
| `trades.py` | ✅ 1 | 435 | 2026-07-08 | V9 API: Trades + management log CRUD. |
