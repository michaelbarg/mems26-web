...
| `adaptive_stop.py` | ✅ 3 | 297 | 2026-06-08 | adaptive_stop.py — Adaptive Stop Engine per D-091 (with 2026-05-23 bug corrections). |
...
| `five_min_system.py` | ✅ 10 | 1622 | 2026-07-14 | FiveMinSystem — 5-min Decision Maker with full D-077 lifecycle. |
| `output_schema.py` | ✅ 4 | 52 | 2026-07-15 | T1Setup — canonical output per D-041. |
| `quality_tier.py` | ✅ 2 | 111 | 2026-07-15 | Quality Tier V2 · Auth Table V1 (pattern x day_type x tier) -> contracts. |
| `setup_emitter.py` | ✅ 4 | 162 | 2026-07-15 | setup_emitter — PATH A: full Layer 3 + validator + gateway composer. |
