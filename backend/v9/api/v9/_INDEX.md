...
| `bars.py` | ✅ 9 | 1737 | 2026-09-09 | V9 API: Bar data endpoints — receives Bridge pushes for all bar types. |
...
| `chart_setup_markers.py` | ✅ 1 | 105 | 2026-09-14 | T-320: GET /api/v9/chart/setup_markers — read-only setup markers for chart. |
...
| `context_radar.py` | ✅ 3 | 360 | 2026-09-03 | GET /api/v9/context/radar — one call, the whole picture (Michael 2026-07-29: |
| `cumulative_delta_routes.py` | ✅ 1 | 298 | 2026-08-22 | API: /api/v9/cumulative_delta — read Sierra cumulative_delta.json export. |
| `day_type_seed.py` | ✅ 2 | 202 | 2026-07-01 | P30 C1 — Mid-session restart IB seeding for Day Type Engine. |
| `day_type_v9_routes.py` | ✅ 2 | 153 | 2026-06-03 | API: /api/v9/day_type/v9/* — V9 Day Type endpoints (3a-S4 REVISED C3). |
| `daytype_classify_routes.py` | ✅ 3 | 466 | 2026-09-07 | V9 API: run the NEW relative day-type classifier over a historical day (read-only). |
...
| `mobile_monitor.py` | ✅ 3 | 1051 | 2026-09-14 | mobile_monitor — מוניטור-אייפון (Michael 2026-07-15, מוגש מהבקאנד). |
...
| `tpo_routes.py` | ✅ 11 | 558 | 2026-08-22 | API: /api/v9/tpo/* — System 5 TPO Profile. |
