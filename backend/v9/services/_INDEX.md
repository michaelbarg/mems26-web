...
| `history_loader.py` | ✅ 2 | 531 | 2026-08-28 | P31 Phase 2 — Startup gap-fill loader. |
...
| `trade_context.py` | ✅ 23 | 1157 | 2026-08-26 | Extract SHADOW trade display fields from v9_trades rows (pattern, trigger, context). |
