...
| `bar_level_detector.py` | ✅ 1 | 158 | 2026-06-18 | BarLevelDetector — glue between BarRouter and W11 TradeManager. |
| `events.py` | ✅ 3 | 85 | 2026-05-22 | Trade event emitter — publishes lifecycle events to Redis pub/sub and WS. |
| `manager.py` | ✅ 7 | 750 | 2026-06-18 | W11 Trade Manager — trade lifecycle: entry -> bracket -> exit. |
