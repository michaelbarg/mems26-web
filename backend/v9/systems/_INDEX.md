...
| `daytype_playbook.py` | ✅ 1 | 131 | 2026-07-02 | Day-type playbook decision engine (flag-gated, default OFF). |
...
| `opening_type_gate.py` | ✅ 1 | 224 | 2026-06-29 | opening_type_gate — blocks counter-drive fires during the opening window. |
