...
|---|---|---|---|---|
| `agent_heartbeat.py` | ▶ entry/test | 53 | 2026-07-11 | Write docs/reports/AGENT_HEARTBEAT.json — the session-watch liveness beacon the |
...
| `mems26_preflight.sh` | — | 107 | 2026-07-13 | mems26_preflight.sh — "האם כל המערכות מחוברות כמו שצריך?" (מייקל 07-13). |
...
| `sync_env_from_ruled.py` | ▶ entry/test | 112 | 2026-07-13 | sync_env_from_ruled — make .env match Michael's RULED_FLAGS.yaml (Michael 07-13). |
