...
| `aggregator.py` | ✅ 1 | 344 | 2026-06-03 | BuildStatusAggregator — joins S2, Woodies, and Day Type system states. |
| `auth_table_lookup.py` | ✅ 2 | 181 | 2026-05-26 | S2 Auth Table V1 — Python const dict lookup. |
| `bridge_inspector.py` | ✅ 1 | 212 | 2026-06-03 | Bridge Live Feed Inspector — per-stream freshness indicators for Build Status. |
