...
|---|---|---|---|---|
| `_probe_spacing_dist.py` | ▶ entry/test | 110 | — | Derivation probe for TARGET_MIN_SPACING_V1's k/m — ladder-gap distribution |
...
| `bar_integrity_check.py` | ▶ entry/test | 101 | — | Bar-stream integrity check — the silent thief under everything (2026-07-29). |
...
| `replay_target_spacing.py` | ▶ entry/test | 323 | — | replay_target_spacing.py — what TARGET_MIN_SPACING_V1 would have done. |
